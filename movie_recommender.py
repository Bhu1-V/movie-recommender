...
# --- Sidebar Navigation ---
page = st.sidebar.radio("Select Page", ["Home", "How it Works?"])
...
if page == "How it Works?":
    try:
        ...
        st.error("README.md file not found. Please ensure the file exists in the app directory.")
else:
    # --- Home Page: Movie Recommender System ---
